...
const images = [
  {
    id: 1,
    url: 'https://picsum.photos/seed/montana/1200/800',
    title: 'Paisaje de montaña'
  },
  {
    id: 2,
    url: 'https://picsum.photos/seed/lago/1200/800',
    title: 'Lago sereno'
  },
  {
    id: 3,
    url: 'https://picsum.photos/seed/bosque/1200/800',
    title: 'Bosque frondoso'
  },
  {
    id: 4,
    url: 'https://picsum.photos/seed/cielo/1200/800',
    title: 'Cielo estrellado'
  },
  {
    id: 5,
    url: 'https://picsum.photos/seed/playa/1200/800',
    ...
    <div className="flex flex-col items-center justify-center py-10 w-full">
      <div className="text-center mb-10">
        ...
        <p className="text-base-content/70">
          Implementado usando <code>Swiper React</code> y DaisyUI para los estilos de la estructura.
        </p>
      </div>
